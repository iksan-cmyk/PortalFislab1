              ...
              <form onsubmit="submitJadwal(event,'${escAttr(r.kelompok)}','${escAttr(mod.judul)}','${escAttr(ses.username)}')">
                <div class="fr">
                  ...
                  <div class="ff"><label>Sesi</label>
                    <select name="sesi">${['Sesi 1 (07.00)','Sesi 2 (09.00)','Sesi 3 (11.00)','Sesi 4 (13.30)', 'Sesi 5 (15.30)', 'Sesi 6 (18.30)', 'Sesi 7 (20.30)'].map(x=>`<option ${s&&s.sesi===x?'selected':''}>${x}</option>`).join('')}</select>
                  </div>
                </div>
